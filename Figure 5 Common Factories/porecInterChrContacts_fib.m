...
load('fibInterChrContacts25mb.mat')
...
% interSize = cellfun('length', interChrContacts.C);
...
counter = 1;
for iInter = 2:5
    chr_specific_inter.(inter_opts{iInter}) = cell(24,1);
...
all_chrs_max_table_fib = all_chrs_max_table;

% temp = cellstr(all_chrs_max_table.Chromosomes_2)
writetable(all_chrs_max_table, 'Inter_Chromosomal_Interactions_Fib.csv');
